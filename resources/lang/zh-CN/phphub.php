...
return [
    ...
    'Congratulations and Welcome!' => '恭喜，欢迎加入 猫友会 社区！',
    ...
    'Document' => '文档',
    'Cloud Server Sponsored by UCloud' => '',
    ...
    'Setup multiple Bindings allow you to login to the same account with different binding site account.' => '绑定多个第三方账号，允许你使用任意一个第三方账号登录同一个 猫友会 账号。',
    ...
    'Bind Successfully!' => '绑定成功！以后可以使用你的 :driver 账号登录 猫友会 了 ^_^',
    'Actived' => '最近访问',
];
